package irene.com.framework.common;
...
public final class ImageLoaderConfig {
    ...
    public static final DisplayImageOptions options = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.ic_round_loading)// 设置图片在下载期间显示的图片
    ...
    public static final DisplayImageOptions options_agent = new DisplayImageOptions.Builder()
    		...
    		.displayer(new SimpleBitmapDisplayer()).build();
    //不使用缓存
    public static final DisplayImageOptions options_agent_not_storage = new DisplayImageOptions.Builder()
            .cacheInMemory(false)// 是否缓存都內存中
